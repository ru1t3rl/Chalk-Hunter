...
namespace Ru1t3rl.ChalkHunter.Utilities
{
    public class MeshCombiner : MonoBehaviour
    {
        ...
        [SerializeField] Transform[] exclusionList;
        ...
        void CombineChildren()
        {
            ...
            {
                if (renderers[i].transform.IsExclusion(exclusionList))
                {
                    continue;
                }
    ...
    public class CombineInstance
    {
        ...
        public void Combine()
        {
            ...
            MeshCollider collider = combinedInstance.AddComponent<MeshCollider>();
            collider.sharedMesh = finalMeshFilter.mesh;            
        }
    }
}
